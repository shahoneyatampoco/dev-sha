  ...
  const projects = [
    {
      ...
      description: 'A comprehensive mobile ERP suite built with Flutter. Features include a support ticketing system, attendance tracking, document scanning, and real-time shipment monitoring.',
    ...
    {
      title: 'AutoPrinting Enterprise Service',
      description: 'Advanced C# Windows Form service for industrial receipt printing. Features automated TCP/IP polling, queue management, and ESC/POS hardware integration.',
      tags: ['C#', '.NET', 'Windows Forms', 'TCP/IP'],
    ...
    },
    {
      ...
      description: 'A dedicated module within the ERP suite for managing customer support tickets with status tracking, assignments, and priority management.',
      tags: ['Flutter', 'Clean Architecture', 'API Integration'],
