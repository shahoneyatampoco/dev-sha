  ...
  const projects = [
    {
      ...
      description: 'Architected a mission-critical mobile ERP suite optimizing workforce efficiency. Engineered complex modules for real-time logistics, biometric attendance, and secure document digitization.',
      tags: ['Flutter', 'Clean Architecture', 'Real-time Systems'],
    ...
    },
    {
      ...
      description: 'Solved critical industrial bottlenecks by engineering a resilient C# service for automated network printing. Implemented robust TCP/IP polling and fail-safe queue management for high-volume environments.',
      tags: ['C#', '.NET', 'Socket Programming', 'Automation'],
    ...
    },
    {
      ...
      description: 'Designed a unified internal tool for hardware/software lifecycle monitoring. Bridged the gap between low-level system logs and actionable management insights.',
      tags: ['Full-Stack', 'Database Design', 'System Monitoring'],
